    ...
    <section id="membership">	        
		<div class="banner-text">
	        ...
	        <div class="banner-video-bg">
	            <video autoplay loop muted playsinline src="@/assets/team-coalition.mp4" />
	        </div>
		</div>	  
				...
				<div class="row">
	                <div class="col-md-6">                
	                    ...
	                    <ol type="i">
	                        ...
	                        <li>Large firms: revenue greater than $55M (5 year running average)</li>
	                        <li>Confirmation of size standard will be conducted in on-boarding activities using sam.gov. </li>
	                    </ol>
					</div>
					<div class="col-md-6"> 
            ...
            <div class="section-details container">
				<div class="row py-5">
					...
					<div class="col-md-6 my-2 benefit-photo"> 
						<img src="@/assets/education.jpg" alt="Person on webinar."/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="py-5" id="policy-and-advocacy">
            <div class="section-details container">
				<div class="row">
	                <div class="col-md-6 my-2"> 
					...
					<div class="col-md-6 benefit-photo my-2"> 
						<img src="@/assets/capitol.jpg" alt="Group of people networking."/>
					</div>
				</div>
			</div>
		</div>
